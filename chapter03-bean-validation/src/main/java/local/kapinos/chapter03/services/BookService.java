...
import local.kapinos.chapter03.interceptor.Loggable;
import local.kapinos.chapter03.interceptor.LoggingInterceptorDirect;
...
public class BookService extends AbstractBookService {
	...
	// Intercepter Type 3
	/**
	 * @see local.kapinos.chapter03.interceptor.LoggingInterceptorDirect
	 */
	@AroundInvoke
